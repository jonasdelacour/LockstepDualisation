...
template <int MaxDegree>
void dualise_V2(const std::vector<node_t>& G_in, const std::vector<uint8_t>& degrees, std::vector<node_t>& G_out , const int N,  const int N_graphs);

template <int MaxDegree>
void dualise_V3(const std::vector<node_t>& G_in, const std::vector<uint8_t>& degrees, std::vector<node_t>& G_out , const int N,  const int N_graphs);