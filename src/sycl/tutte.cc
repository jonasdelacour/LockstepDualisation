...
void tutte_layout_sycl(sycl::queue& Q, IsomerBatch<T,K>& batch, const LaunchPolicy policy){
...
template void tutte_layout_sycl<float,uint16_t>(sycl::queue& Q, IsomerBatch<float,uint16_t>& batch, const LaunchPolicy policy);