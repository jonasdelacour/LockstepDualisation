...
int declare_cu_arrays(){
    CuArray<float> f1_a;                    CuArray<float> f1(1);           f1_a = f1;f1[0] = {};   std::cout << f1;  f1.to_device(0); f1.to_host(); 
    CuArray<double> f2_a;                   CuArray<double> f2(1);          f2_a = f2;f2[0] = {};   std::cout << f2; f2.to_device(0); f2.to_host();
    CuArray<int> f7_a;                      CuArray<int> f7(1);             f7_a = f7;f7[0] = {};   std::cout << f7; f7.to_device(0); f7.to_host();
    CuArray<size_t> f8_a;                   CuArray<size_t> f8(1);          f8_a = f8;f8[0] = {};   std::cout << f8; f8.to_device(0); f8.to_host();
    CuArray<uint8_t> f9_a;                  CuArray<uint8_t> f9(1);         f9_a = f9;f9[0] = {};   std::cout << f9; f9.to_device(0); f9.to_host();
    CuArray<unsigned char> f9_2_a;          CuArray<unsigned char> f9_2(1); f9_2_a = f9_2;f9_2[0] = {}; std::cout << f9_2; f9_2.to_device(0); f9_2.to_host();
    CuArray<uint16_t> f10_a;                CuArray<uint16_t> f10(1);       f10_a = f10;f10[0] = {};  std::cout << f10; f10.to_device(0); f10.to_host();
    CuArray<unsigned short> f10_2_a;        CuArray<unsigned short> f10_2(1); f10_2_a = f10_2;f10_2[0] = {};  std::cout << f10_2; f10_2.to_device(0); f10_2.to_host();
    CuArray<uint32_t> f11_a;                CuArray<uint32_t> f11(1);       f11_a = f11;f11[0] = {};  std::cout << f11; f11.to_device(0); f11.to_host();
    CuArray<uint64_t> f12_a;                CuArray<uint64_t> f12(1);       f12_a = f12;f12[0] = {};  std::cout << f12; f12.to_device(0); f12.to_host();
    CuArray<char> f13_a;                    CuArray<char> f13(1);           f13_a = f13;f13[0] = {};  std::cout << f13; f13.to_device(0); f13.to_host();
    CuArray<bool> f14_a;                    CuArray<bool> f14(1);           f14_a = f14;f14[0] = {};  std::cout << f14; f14.to_device(0); f14.to_host();
    return 1;
}
